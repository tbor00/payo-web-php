<?php
$loc_title = $default->web_title . " - ".translate("Resumen de Cuenta");
$db = connect();
$db->debug = SDEBUG;
...
if ($_SESSION[logged]){
	...
	echo "<tr><th style=\"text-align:left;\">Resumen de Cuenta</th></tr>";
	echo "<tr><th style=\"text-align:left;\">Cliente: $razon_social</th></tr>";
	echo "<tr><th style=\"text-align:left;\">C.U.I.T: $cuit</th></tr>";
	echo "</table></tr>";

	$query = "SELECT * FROM e_ctasctes WHERE cliente_eb=$cliente_eb AND gestion='".$gestion."' ORDER by fecha,id";
	...
	if ($ctacte_r && !$ctacte_r->EOF){
		...
		echo "<TH style=\"border: 1pt solid; \">Cr&eacute;dito</TH>";
		echo "<TH style=\"border: 1pt solid; \">D&eacute;bito</TH>";
