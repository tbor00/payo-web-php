...
$config['include_form']="templates/listar_menues.inc.php";
$config['id']="id_menu";
...
$config['listar_condicion']="tipo=4";
$config['em_condicion']="id_menu=$id";
$config['eliminar_control']=array('e_menues'=>"e_menues.menu_id='$id': En un Submen&uacute;.");
$config['modificar_control']=array('e_menues'=>"titulo='$titulo[1]' AND tipo=".$config['menu_tipo']." AND id_menu!='$id'");
$config['alta_control']=array('e_menues'=>"titulo='$titulo[1]' AND tipo=".$config['menu_tipo']);
...
switch($op){
	...
	case 'cm':{
		...
		foreach ($default->lenguajes($config['set_idioma']) as $id_l){
			...
			$config['campos'][$id_l]["bgcolor"]=$bgcolor[1];
		}
		// -------------------------------------------------------------
		// -------------------------------------------------------------
	...
	case 'o':{
		...
		$config['op']="cm";
		include('include/templates/form_header.inc.php');
		$config['include_form']="forms/menues_ord.inc.php";
