...
$config['menu']="Otras P&aacute;ginas";
...
$config['agregar']="yes";
$config['delete']="yes";
$config['form_edit']="forms/otherpage.inc.php";
$config['listar_condicion']="tipo = '$config[tipo]'";
$config['em_condicion']="id_menu=$id";
$config['eliminar_control']=array('e_menu_adic'=>"e_menu_adic.menu_id='$id':en adicionales",);
