...
//--------------------------------------------------------- 
function OpenEditorHTML(ecampo,reservado,absurl){ 
	...
	if (absurl != ""){ 
		seccion="&absoluteurl=" + absurl; 
	} else { 
		seccion=""; 
	} 
	url = "editor/editor.php?campo=" + ecampo + reservado + seccion; 
	edito=window.open( url , "htmleditor",sPropsVentana); 
} 
//--------------------------------------------------------- 
function PreviewHTML(ftitle,fcampo){ 
	var altoPantalla = window.screen.height; 
	var anchoPantalla = window.screen.width; 
	var sPropsVentana; 
	var height = "520"; 
	...
	url = "../preview.php?titulo=" + ftitle + "&campo=" + fcampo; 
	edito=window.open( url , "htmlpreview",sPropsVentana); 
} 
//-------------------------------------- 
