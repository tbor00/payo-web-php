...
function hash(form,login_url) {
    ...
    if (valid_js()) {
      var passwd = form.npasswd.value;
      var hash1 = MD5(form.npasswd.value);
      var challenge = form["challenge"].value;
      var hash2 = MD5(form.npasswd.value) + challenge;
      var hash;
      
      
      if(form.npasswd.value){
        hash=MD5(hash2);
      } else {
        hash="";
      }
      ...
      for(i=0; i<form.elements.length; i++){
        ...
        if( (form.elements[i].name != "challenge") && (form.elements[i].name != ".save") ){
        ...
        } else if(form.elements[i].name == "npasswd"){
	    if (document.forms[0].npasswd.value == '') {
		return false;
	    } else {
		document.forms[0].passwd.value = hash;
		document.forms[0].npasswd.value = '';
	    }    

        } else if (form.elements[i].name == ".js"){
          js = 1;
          url += "1";           
        } else if (form.elements[i].name == "challenge"){
        	// No se Hace Nada
        } else {
